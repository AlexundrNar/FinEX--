        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="/" className="flex items-center">
              <img
                src="https://st2.depositphotos.com/1768926/12355/v/950/depositphotos_123553734-stock-illustration-letter-logo-business-finance-logo.jpg"
            ...
            <div className="flex items-center lg:order-2">
              ...
              <button
                ...
                aria-expanded="false"
              >
                <span className="sr-only">Основное меню</span>
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  <a
                    href="/"
                    className="block py-2 pr-4 pl-3 text-white rounded bg-primary-600 lg:bg-transparent lg:text-primary-600 lg:p-0 dark:text-white"
                    aria-current="page"
                  >
                    Цифровая валюта
                  </a>
